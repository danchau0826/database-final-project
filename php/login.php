    ...
    <div id="User_part" class="tabcontent">
      ...
      <form action="login.php" method="post">
        ...
        <div class="input-group">
          ...
          <input type="password" name="password" placeholder="Enter password" style="margin: 5px 0 22px 0;border: none; width: 40%; height: 40px; padding: 5px; position: relative; left: 550px;">
        </div>
        <div class="input-group">
