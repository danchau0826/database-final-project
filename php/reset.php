...
<html>
  ...
  <body>
    ...
    <div id="User_part" class="tabcontent">
      <h1 style="position: relative; left: 785px; top: 10px; font-size: 50px;">Reset here!</h1>
      <form action="reset.php" method="post">
        ...
        <div class="input-group">
          <label style="font-size: 30px; position: relative; left: 550px;">New password<br></label>
        ...
        <div class="input-group">
          <label style="font-size: 30px; position: relative; left: 550px;">Confirm new password<br></label>
          <input type="password" name="password_2" placeholder="Enter new password again!" style="margin: 5px 0 22px 0;border: none; width: 40%; height: 40px; padding: 5px; position: relative; left: 550px;">
        </div>
        <div class="input-group">
          <button type="submit" class="btn" name="user_reset" style="margin: 5px 0 22px 0;border: none; width: 40%; height: 60px; padding: 5px; position: relative; left: 550px; font-size: 20px;">Reset !</button>
        </div>
		<p style="font-size: 20px; position: relative; left: 550px;">
            Back to login? <a style="font-size: 20px; color: red" href="login.php" >Login here</a>
        </p>
      </form>
    </div>
