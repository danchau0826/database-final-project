...
<html>
  ...
  <body>
    ...
    <!--上面的目錄標誌-->
    <button class="tablink" onclick="openPage('Home', this, '#a9a9a9')" id="defaultOpen"><a class="active" href="#"><i class="fa fa-home"></i></a> Home</button>
    ...
    <div id="Ranking" class="tabcontent">
      <h1 style="position: relative; left: 600px; top: 0px; font-size: 45px;">TOP 100 Highest Rating books! </h1>
      <?php
       require('db.php');
